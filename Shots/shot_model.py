...
# Test the model on a random feature vector
random_feature = random_feature.reshape(1, -1)
random_label = random_label.reshape(1, -1)

# Predict the label for the random feature vector
